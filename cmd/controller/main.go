...
import (
	...
	_ "github.com/aws-controllers-k8s/opensearchserverless-controller/pkg/resource/security_config"
...
var (
	awsServiceAPIGroup = "opensearchserverless.services.k8s.aws"
	awsServiceAlias    = "opensearchserverless"
