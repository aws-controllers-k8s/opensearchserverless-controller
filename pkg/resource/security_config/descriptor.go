...
const (
	FinalizerString = "finalizers.opensearchserverless.services.k8s.aws/SecurityConfig"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("securityconfigs")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.SecurityConfig{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.SecurityConfig),
	}
}
