...
// +kubebuilder:rbac:groups=opensearchserverless.services.k8s.aws,resources=securityconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=opensearchserverless.services.k8s.aws,resources=securityconfigs/status,verbs=get;update;patch
