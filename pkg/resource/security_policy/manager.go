...
// +kubebuilder:rbac:groups=opensearchserverless.services.k8s.aws,resources=securitypolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=opensearchserverless.services.k8s.aws,resources=securitypolicies/status,verbs=get;update;patch
...
func (rm *resourceManager) ARNFromName(name string) string {
	return fmt.Sprintf(
		"arn:aws:opensearchserverless:%s:%s:%s",
		rm.awsRegion,
		rm.awsAccountID,
		name,
	)
