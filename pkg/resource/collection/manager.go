...
// +kubebuilder:rbac:groups=opensearchserverless.services.k8s.aws,resources=collections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=opensearchserverless.services.k8s.aws,resources=collections/status,verbs=get;update;patch
