...
const (
	FinalizerString = "finalizers.opensearchserverless.services.k8s.aws/Collection"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("collections")
