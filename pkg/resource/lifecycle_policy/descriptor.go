...
const (
	FinalizerString = "finalizers.opensearchserverless.services.k8s.aws/LifecyclePolicy"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("lifecyclepolicies")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.LifecyclePolicy{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.LifecyclePolicy),
	}
}
