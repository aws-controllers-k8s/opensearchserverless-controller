...
// +kubebuilder:rbac:groups=opensearchserverless.services.k8s.aws,resources=lifecyclepolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=opensearchserverless.services.k8s.aws,resources=lifecyclepolicies/status,verbs=get;update;patch
...
func (rm *resourceManager) ARNFromName(name string) string {
	return fmt.Sprintf(
		"arn:%s:opensearchserverless:%s:%s:%s",
		rm.awsPartition,
		rm.awsRegion,
		rm.awsAccountID,
		name,
