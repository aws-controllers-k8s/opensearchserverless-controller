...
// +kubebuilder:rbac:groups=opensearchserverless.services.k8s.aws,resources=accesspolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=opensearchserverless.services.k8s.aws,resources=accesspolicies/status,verbs=get;update;patch
