...
const (
	FinalizerString = "finalizers.opensearchserverless.services.k8s.aws/AccessPolicy"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("accesspolicies")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.AccessPolicy{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.AccessPolicy),
	}
}
